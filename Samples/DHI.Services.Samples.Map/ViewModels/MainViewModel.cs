...
namespace DHI.Services.Samples.Map.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        private string _styleCode = "Default"; // used if no styles.json
        private string _item = "1";            // item number or name
        ...
        private double _minX = -20037508; // fallback world mercator
        ...
        private string _isoline = "None"; // enum string (provider expects)
        ...
        private string _status = "Pick a DFS2 file or a folder…";
        ...
        {
            get => _styleCode;
            set { _styleCode = value; OnPropertyChanged(); }
        }
        ...
        {
            get => _crs;
            set { _crs = value; OnPropertyChanged(); }
        }

        public int ImageWidth
        {
            get => _width;
            set { _width = Math.Max(100, value); OnPropertyChanged(); }
        }

        public int ImageHeight
        {
            get => _height;
            set { _height = Math.Max(100, value); OnPropertyChanged(); }
        }
        ...
        public bool IncludeVector
        {
            get => _includeVector;
            set { _includeVector = value; OnPropertyChanged(); }
        }

        public string VectorColor
        {
            get => _vectorColor;
            set { _vectorColor = value; OnPropertyChanged(); }
        }

        public string Isoline
        {
            get => _isoline;
            set { _isoline = value; OnPropertyChanged(); }
        }

        public string ColoringType
        {
            get => _coloringType;
            set { _coloringType = value; OnPropertyChanged(); }
        }

        public string ShadingType
        {
            get => _shadingType;
            set { _shadingType = value; OnPropertyChanged(); }
        }

        public int VectorMaxLength
        {
            get => _vectorMaxLength;
            set { _vectorMaxLength = Math.Max(0, value); OnPropertyChanged(); }
        }
        ...
        private void BrowseFile()
        {
            ...
            {
                Filter = "MIKE DFS2 (*.dfs2)|*.dfs2",
                Title = "Open DFS2 File"
            };
        ...
        {
            using var dlg = new System.Windows.Forms.FolderBrowserDialog { Description = "Pick a folder with .dfs2 files" };
        ...
        private void Render()
        {
            ...
            try
            {
                ...
                var bmp = _adapter.Render(style, CRS, bbox, ImageWidth, ImageHeight, SelectedSourceId!, SelectedTime, Item, p);

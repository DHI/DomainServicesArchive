namespace DHI.Services.GIS.Maps
{
    ...
    /// <summary>
    ///     Map Service Connection with memory based caching.
    /// </summary>
    public class CachedMapServiceConnection : MapServiceConnection
    {
        /// <summary>
        ...
        public new static ConnectionType CreateConnectionType<TConnection>(string path = null) where TConnection : CachedMapServiceConnection
        {
            var connectionType = new ConnectionType("CachedMapServiceConnection", typeof(TConnection));

namespace DHI.Services.GIS.Maps
{
    ...
    /// <summary>
    ///     Connection for creation of a MapService.
    /// </summary>
    public class MapServiceConnection : BaseConnection
    {
        /// <summary>
        ...
        public static ConnectionType CreateConnectionType<TConnection>(string path = null) where TConnection : MapServiceConnection
        {
            var connectionType = new ConnectionType("MapServiceConnection", typeof(TConnection));

namespace DHI.Services.Connections.WebApi.Host.Test
{
    ...
    {
        private const string AppDataPath = @"..\..\..\..\DHI.Services.Connections.WebApi.Host\App_data";
        ...
        private void _CopyToTempAppDataPath(string sourceFileName, string sourceDir = AppDataPath, string newName = null)
        {
            newName ??= sourceFileName;
            var destinationFilePath = Path.Combine(_tempAppDataPath, newName);

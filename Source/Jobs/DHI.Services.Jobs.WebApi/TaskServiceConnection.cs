    ...
    public class TaskServiceConnection : TaskServiceConnection<Workflow, string>
    {
        ...
        public override object Create()
        {
            try
            {
                ...
                var repository = Activator.CreateInstance(repositoryType, ConnectionString.Resolve(), null);
                var taskService = new TaskService<Workflow, string>((ITaskRepository<Workflow, string>)repository);
                return taskService;
            }

namespace DHI.Services.Documents
{
    ...
    public class DocumentServiceConnection<TId> : BaseConnection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentServiceConnection{TId}" /> class.
        /// </summary>
        ...
        public static ConnectionType CreateConnectionType<TConnection>(string path = null) where TConnection : DocumentServiceConnection<TId>
        {
            var connectionType = new ConnectionType("DocumentServiceConnection", typeof (TConnection));
            connectionType.ProviderTypes.Add(new ProviderType("RepositoryType", DocumentService<TId>.GetRepositoryTypes(path)));
        ...
        public override object Create()
        {
            try
            {
                ...
                return new DocumentService<TId>((IDocumentRepository<TId>)repository);
            }

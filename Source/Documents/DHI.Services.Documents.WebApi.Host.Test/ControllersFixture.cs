namespace DHI.Services.Documents.WebApi.Host.Test
{
    ...
    {
        private const string AppDataPath = @"..\..\..\..\DHI.Services.Documents.WebApi.Host\App_data";
        ...
        public ControllersFixture()
        {
            ...
            _CopyToTempAppDataPath("MCSQLiteTest.sqlite");
            _CopyToTempAppDataPath("HowdyWorld.txt");
            Client = CreateClient();

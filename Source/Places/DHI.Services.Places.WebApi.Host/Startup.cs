namespace DHI.Services.Places.WebApi.Host
{
    using System;
    ...
    public class Startup
    {
            ...
            services
                ...
                .AddControllers()
                 .AddJsonOptions(options =>
                 {
                     ...
                     options.JsonSerializerOptions.NumberHandling = SerializerOptionsDefault.Options.NumberHandling;
        ...
        public virtual void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // Set the data directory (App_Data folder) for Domain Services

namespace DHI.Services
{
    ...
    public abstract class BaseEntity<TId> : ISecuredEntity<TId>, ICloneable where TId : notnull
    {
        ...
        public virtual T Clone<T>()
        {
            ...
            //foreach (var converter in Converters.JsonConverterDefault.ConverterFor<T>())
            //{
            ...
            var cloned = CloneObjectHelper.DeepCopyByExpressionTree(this);
            //return (T)Convert.ChangeType(cloned, typeof(T)); 

namespace DHI.Services
{
    ...
    public abstract class BaseDiscreteRepository<TEntity, TEntityId> : IRepository<TEntity, TEntityId>, IDiscreteRepository<TEntity, TEntityId> where TEntity : IEntity<TEntityId>
    {
        /// <summary>

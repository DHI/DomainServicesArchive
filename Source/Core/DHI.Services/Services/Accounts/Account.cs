namespace DHI.Services.Accounts
{
    ...
    public class Account : BaseNamedEntity<string>
    {
        ...
        /// <summary>
        ///     Gets or sets a value to indicate how many unsuccessful login attempt that can account tries when try to login.
        /// </summary>
        /// <value> the NoOfUnsuccessfulLoginAttempts</value>
        public virtual int NoOfUnsuccessfulLoginAttempts { get; set; }

        /// <summary>
        ///     Gets or sets a value to indicate the the last date when user attempted to login the account 
        /// </summary>
        /// <value> the LastLoginDate</value>
        public virtual DateTime LastLoginAttemptedDate { get; set; } = DateTime.Now;

        /// <summary>
        ///     Gets or sets a value indicating a user account lock status.
        /// </summary>
        /// <value>
        ///     <c>true</c> if a user accounte lock status is locked; otherwise, <c>false</c>.
        /// </value>
        public virtual bool Locked { get; set; } = false;

        /// <summary>
        ///     Gets or sets a value to indicate the expired date when account is locked 
        /// </summary>
        /// <value> the LockedDateEnd</value>
        public virtual DateTime? LockedDateEnd { get; set; }
        ...
        public bool ValidatePassword(string password)
        {
            ...
            {
                return Account.HashPassword(password).SequenceEqual(_encryptedPassword);
            }

namespace DHI.Services.Test
{
    ...
    public sealed class GroupedJsonRepositoryTest : IDisposable
    {
        ...
        [Fact(Skip = "Contains will simply return false even with invalid Id")]
        ...
        public void CaseInsensitiveComparerIsOk()
        {
            ...
            Assert.Single(repository.Get(entity => entity.Name.StartsWith("my", StringComparison.InvariantCultureIgnoreCase)));
        }
        ...
        public void GetAllReturnsClones(FakeGroupedEntity entity)
        {
            ...
            var en = _repository.Get(entity.FullName);

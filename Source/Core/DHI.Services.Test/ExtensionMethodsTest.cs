namespace DHI.Services.Test
{
    ...
    public class ExtensionMethodsTest
    {
        ...
        [Fact]
        public void ResolveAssemblyNameIsOk()
        {
            var type = new System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, BaseEntity<double>>>();

            var actualFullName = type.GetType().ResolveTypeFriendlyName((null, null));
            var expectedFullName = type.GetType().FullName;

            var actualFriendlyName = type.GetType().ResolveTypeFriendlyName();
            var expectedFriendlyName = "System.Collections.Generic.Dictionary`2[[System.String, mscorlib],[System.Collections.Generic.Dictionary`2[[System.String, mscorlib],[DHI.Services.BaseEntity`1[[System.Double, mscorlib]], DHI.Services.BaseEntity`1]], mscorlib]]";

            Assert.Equal(expectedFullName, actualFullName);
            Assert.Equal(expectedFriendlyName, actualFriendlyName);
        }

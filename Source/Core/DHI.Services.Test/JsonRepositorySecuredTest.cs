namespace DHI.Services.Test
{
    ...
    public sealed class JsonRepositorySecuredTest : IClassFixture<JsonRepositorySecuredFixture>, IDisposable
    {
        ...
        {
            _repository.Add(entity);
            Assert.Single(_repository.GetAll(_user));
        ...
        public void CaseInsensitiveComparerIsOk()
        {
            ...
            Assert.Single(repository.Get(entity => entity.Id.StartsWith("my", StringComparison.InvariantCultureIgnoreCase), _user));
        }
        ...
        public void GetAllReturnsClones(FakeEntitySecured entity)
        {
            ...
            Assert.DoesNotContain("Description", _repository.Get(entity.Id, _user).Value.Metadata);
        }
        ...
        {
            _repository.Add(entity);
            Assert.Single(_repository.Get(ent => ent.Id == entity.Id, _user));

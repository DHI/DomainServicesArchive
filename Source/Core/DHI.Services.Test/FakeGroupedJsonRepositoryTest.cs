namespace DHI.Services.Test
{
    ...
    public class FakeGroupedJsonRepositoryTest
    {
        private readonly FakeGroupedJsonRepository<FakeGroupedEntity> _repository;

        public FakeGroupedJsonRepositoryTest()
        {
            _repository = new FakeGroupedJsonRepository<FakeGroupedEntity>();
        }
        ...
        public void GetByGroupIsOk(FakeGroupedEntity entity1, FakeGroupedEntity entity2)
        {
            ...
            Assert.Single(_repository.GetByGroup(entity2.Group));
        }
        ...
        public void GetFullNamesByGroupIsOk(FakeGroupedEntity entity1, FakeGroupedEntity entity2)
        {
            ...
            Assert.Single(_repository.GetFullNames(entity2.Group));

namespace DHI.Services.Logging.WebApi.Host.Test
{
    ...
    {
        private const string _appDataPath = @"..\..\..\..\DHI.Services.Logging.WebApi.Host\App_data";
        ...
        public ControllersFixture()
        {
            ...
            _CopyToTempAppDataPath("log.log");
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            foreach (var logService in ServiceLocator.GetAll<LogService>())
            {
                try
                {
                    logService.Dispose();

...
dotnet nuget push ..\bin\%configuration%\DHI.Services.Logging.WebApi.*.nupkg --source http://dhi-nuget-server.azurewebsites.net/nuget --api-key dhi-nuget-admin >> %logfile% 2>&1

...
:CONTINUE
echo.
echo ===== Building & Pushing Rasters.WebApi NuGet Package =====
echo.
...
echo [PACK] dotnet pack ..\DHI.Services.Rasters.WebApi.csproj --configuration %configuration%
dotnet pack ..\DHI.Services.Rasters.WebApi.csproj --configuration %configuration%
echo.

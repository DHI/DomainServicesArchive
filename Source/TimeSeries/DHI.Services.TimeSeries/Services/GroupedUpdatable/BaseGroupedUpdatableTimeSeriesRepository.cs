namespace DHI.Services.TimeSeries
{
    ...
    public abstract class BaseGroupedUpdatableTimeSeriesRepository<TId, TValue> : BaseUpdatableTimeSeriesRepository<TId, TValue>, IGroupedUpdatableTimeSeriesRepository<TId, TValue> where TValue : struct, IComparable<TValue>
    {

namespace DHI.Services.TimeSeries
{
    ...
    /// <summary>
    ///     Grouped, discrete Time Series Service.
    /// </summary>
    ...
    public class GroupedDiscreteTimeSeriesService<TId, TValue> : BaseGroupedDiscreteService<TimeSeries<TId, TValue>, TId>, IGroupedDiscreteTimeSeriesService<TId, TValue> where TValue : struct, IComparable<TValue>
    {
        private readonly DiscreteTimeSeriesService<TId, TValue> _timeSeriesService;

        /// <summary>
        ///     Initializes a new instance of the <see cref="GroupedDiscreteTimeSeriesService{TId, TValue}" /> class.
        /// </summary>
        /// <param name="repository">The repository.</param>
        public GroupedDiscreteTimeSeriesService(IGroupedDiscreteTimeSeriesRepository<TId, TValue> repository) 
            : base(repository)
        {
        ...
        public GroupedDiscreteTimeSeriesService(IGroupedDiscreteTimeSeriesRepository<TId, TValue> repository, ILogger logger)
        ...
        /// <summary>
        ///     Gets the value at the specified datetime.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="dateTime">The date time.</param>
        /// <param name="user">The user.</param>
        ...
        {
            return Service.GetProviderTypes<IGroupedDiscreteTimeSeriesRepository<TId, TValue>>();
        }
        ...
        {
            return Service.GetProviderTypes<IGroupedDiscreteTimeSeriesRepository<TId, TValue>>(path);
        }
        ...
        {
            return Service.GetProviderTypes<IGroupedDiscreteTimeSeriesRepository<TId, TValue>>(path, searchPattern);
        }

        /// <summary>
        ///     Gets the interpolated value at the specified date time.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="dateTime">The date time.</param>
        /// <param name="user">The user.</param>
        ...
        /// <summary>
        ///     Gets the values within the given time interval with interpolated end points.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="from">Interval start.</param>
        /// <param name="to">Interval end.</param>
    ...
    /// <inheritdoc />
    public class GroupedDiscreteTimeSeriesService : GroupedDiscreteTimeSeriesService<string, double>
    {
        /// <inheritdoc />
        public GroupedDiscreteTimeSeriesService(IGroupedDiscreteTimeSeriesRepository<string, double> repository)
            : base(repository)
        {
        }

        /// <inheritdoc />
        public GroupedDiscreteTimeSeriesService(IGroupedDiscreteTimeSeriesRepository<string, double> repository, ILogger logger)
            : base(repository, logger)
        {
        }
    }

namespace DHI.Services.TimeSeries.Web
{
    ...
    /// <summary>
    ///     Class TimeSeriesDataConverter (Obsolete).
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <typeparam name="TFlag">The type of the flag.</typeparam>
    /// <seealso cref="Newtonsoft.Json.JsonConverter" />
    [Obsolete("Please use TimeSeriesDataConverter<TValue> or TimeSeriesDataWFlagConverter<TValue, TFlag> instead.")]
    public class TimeSeriesDataConverter<TValue, TFlag> : JsonConverter where TValue : struct
    {
        /// <summary>
